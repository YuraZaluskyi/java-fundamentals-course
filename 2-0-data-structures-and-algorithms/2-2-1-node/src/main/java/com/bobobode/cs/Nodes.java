...
//        throw new ExerciseNotCompletedException(); // todo:
  ...
  /**
   * Create a connection between first and second nodes, so object first stores a reference to the
   * second.
   *
...
//    throw new ExerciseNotCompletedException(); // todo:
  ...
  /**
   * Creates two new {@link Node} objects using provided firstElement and secondElement, and create
   * a connection between those two elements so the first node will hold a reference to a second
   * one.
   *
...
//    throw new ExerciseNotCompletedException(); // todo:
  ...
  /**
   * Creates two new {@link Node} objects using provided firstElement and secondElement, and creates
   * connections between those nodes so the first node will hold a reference to a second one, and a
   * second node will hold a reference to the first one.
   *
   * @param firstElement any element of type T
   * @param secondElement any element of type T
...
//    throw new ExerciseNotCompletedException(); // todo:
  ...
  /**
   * Creates a linked chain of {@link Node} objects based on provided elements. Creates a connection
   * between those nodes so each node will hold a reference to the next one in the chain. HINT: it's
...
//    throw new ExerciseNotCompletedException(); // todo:
   ...
   * connection between those nodes so each node will hold a reference to the next one in the chain,
   * and the last one will hold a reference to the first one.
   *
   * @param elements a array of elements of type T
   * @param <T> generic type T
   * @return a reference to the first element of the chain
