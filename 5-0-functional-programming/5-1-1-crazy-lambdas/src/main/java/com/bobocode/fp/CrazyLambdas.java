 ...
 * should be implemented using either lambda or a method reference. Every method that is not
 * implemented yet throws {@link ExerciseNotCompletedException}.
 * <p>
...
//    throw new ExerciseNotCompletedException();
    BiFunction<String, Integer, String> function = (str, number) -> {
...
//    throw new ExerciseNotCompletedException();
  ...
  /**
   * Returns a {@link UnaryOperator} that accepts str to str function and returns the same function
   * composed with trim
   *
...
//    throw new ExerciseNotCompletedException();
  ...
  /**
   * Returns a {@link BiFunction} which first parameter is a {@link Map} where key is a function
   * name, and value is some {@link IntUnaryOperator}, and second parameter is a {@link String}
   * which is a function name. If the map contains a function by a given name then it is returned by
   * high order function otherwise an identity() is returned.
   *
